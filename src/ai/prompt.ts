...
export const SYSTEM_PROMPT = [
  ...
  '- Assign every turn you are given to the topic it belongs to.',
  ...
  '- Do not put a turn in a topic it is not about, and never use "shared". It is better to leave a turn out than to put it in every topic.',
